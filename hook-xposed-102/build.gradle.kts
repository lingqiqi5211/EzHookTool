...
val checkApi102Gateway =
    tasks.register("checkApi102Gateway") {
        group = "verification"
        ...
        doLast {
            ...
            val forbidden =
                Regex(
                    """(?<!Api102)\.(?:(?:replaceHook|setId|setSavedInstanceState)\(|getId\(\)|detach\(\)|savedInstanceState\b|oldHookHandles\b)""",
                )
            val hits =
