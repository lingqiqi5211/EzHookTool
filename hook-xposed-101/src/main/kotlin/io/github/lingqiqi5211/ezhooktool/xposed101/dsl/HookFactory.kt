package io.github.lingqiqi5211.ezhooktool.xposed101.dsl
...
import io.github.lingqiqi5211.ezhooktool.xposed101.InvocationContext
import io.github.lingqiqi5211.ezhooktool.xposed101.dispatchStages
 ...
 *
 * 支持 `before`、`after`、`replace`、`intercept`、优先级和异常模式配置。
 */
class HookFactory internal constructor(
    ...
    /**
     * 注册 around/intercept 回调，可自行决定是否继续原始调用。
     *
    ...
    /**
     * 注册 libxposed 原生 `Hooker` 形式的 intercept 回调。
     *
